...
class CInteropArguments : CommonInteropArguments() {
    // TODO: a better description needed.
    @Argument(value = "-import", valueDescription = "<imports>", description = "a semicolon separated list of imports") 
    ...
    @Argument(value = "-header", shortName = "-h",  valueDescription = "<file>", description = "header file to produce kotling bindings for") 
    var header: Array<String> = arrayOf()

    @Argument(value = HEADER_FILTER_ADDITIONAL_SEARCH_PREFIX, shortName = "-hfasp",  valueDescription = "<file>", description = "header file to produce kotling bindings for") 
    var headerFilterPrefix: Array<String> = arrayOf()

    // It conflicts with -h meaning header.
    //@Argument(value = "-h", valueDescription = "<file>", description = "an alternative location of konan.properties file") 
